...
public interface ErrorConstant {
    ...
    interface File {
        static final String ADD_NEW_FILE_FAIL = "添加文件信息失败";
        static final String DELETE_FILE_FAIL = "删除文件信息失败";
        static final String DELETE_SERVERFILE_FAIL = "从服务器删除文件失败";
        static final String UPLOAD_FILE_FAIL = "上传文件失败";
        static final String FILE_ISNULL = "文件不能为空";
        static final String FILE_ARR_ISNULL = "文件数组不能为空";
    }
