...
public class Commons {
    ...
    public static String fmtdate_time(Integer unixTime){
    ...
    /**
     * @Description : 判断后缀是否是图片
     * @author : jiangyuzhen
     * @date : 2019/12/19 17:10
     * @param fileSuffix :
     * @return : boolean
     */
    public static boolean is_image(String fileSuffix) {
        // 文件名称为空的场合
        ...
        for (int i = 0; i < imgeArray.length; i++) {
            // 判断单个类型文件的场合
            if (imgeArray[i].equals(fileSuffix.toLowerCase())) {
                return true;
            }
        }
        return false;
